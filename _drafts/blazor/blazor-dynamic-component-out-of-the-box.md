...
Let's uderstan
I have created two component `ListView` and `TableView` and then poppulated the dropdown list with components.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc4NDYxMzAyMSwxODcwODY4OTQ1LDIxMD
