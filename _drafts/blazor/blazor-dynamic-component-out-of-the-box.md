...
Let's consider you want to show todo list as list view and table view as shown in the below image. You can easily developed this functionality using `DynamicComponent`. 
Let's uderstand this with an example.I have created two component `ListView` and `TableView` and then poppulated the dropdown list with components.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDA4ODkxOTQwLDE4NzA4Njg5NDUsMjEwND
I5OTc1OCw2ODM5NjQ1NjIsMTMxNjI1OTYxMiw4NTEyNTA2MDks
MTQ2MjgwNDQ0NF19
-->